...
userEnter = UserInput("Введите вещественные числа через пробел: ")
splitList = userEnter.split(" ")
newList = []
newList = FillList(splitList)
...
answer = float(int(differ*100)/100)                          #Перевод вещественного числа в целое с умножением 2-ух остатков и обратно для красоты
