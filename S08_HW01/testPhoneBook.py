...
def Search_Button():
    try:
        ...
        logging.config.fileConfig('logging.conf')
        logger = logging.getLogger("phoneBook")
        logger.error("Error with Input Info")    
...
def Credits_Button():
    messagebox.showinfo('Разработчики', 'Кинслер Станислав Викторович \nhttps://gb.ru GeekBrains \nhttps://github.com/StanleyKeys')
...
creditsButton = Button(window, text="Разработчики", command=Credits_Button)
creditsButton.place(x=470, y=460)
#------------------------------------------------------------------------------
